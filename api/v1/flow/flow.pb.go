...
var file_flow_flow_proto_depIdxs = []int32{
	...
	27, // 31: flow.HTTP.headers:type_name -> flow.HTTPHeader
	9,  // 32: flow.LostEvent.source:type_name -> flow.LostEventSource
	46, // 33: flow.LostEvent.cpu:type_name -> google.protobuf.Int32Value
	10, // 34: flow.AgentEvent.type:type_name -> flow.AgentEventType
	33, // 35: flow.AgentEvent.unknown:type_name -> flow.AgentEventUnknown
	34, // 36: flow.AgentEvent.agent_start:type_name -> flow.TimeNotification
	35, // 37: flow.AgentEvent.policy_update:type_name -> flow.PolicyUpdateNotification
	36, // 38: flow.AgentEvent.endpoint_regenerate:type_name -> flow.EndpointRegenNotification
	37, // 39: flow.AgentEvent.endpoint_update:type_name -> flow.EndpointUpdateNotification
	38, // 40: flow.AgentEvent.ipcache_update:type_name -> flow.IPCacheNotification
	40, // 41: flow.AgentEvent.service_upsert:type_name -> flow.ServiceUpsertNotification
	41, // 42: flow.AgentEvent.service_delete:type_name -> flow.ServiceDeleteNotification
	44, // 43: flow.TimeNotification.time:type_name -> google.protobuf.Timestamp
	47, // 44: flow.IPCacheNotification.old_identity:type_name -> google.protobuf.UInt32Value
	39, // 45: flow.ServiceUpsertNotification.frontend_address:type_name -> flow.ServiceUpsertNotificationAddr
	39, // 46: flow.ServiceUpsertNotification.backend_addresses:type_name -> flow.ServiceUpsertNotificationAddr
	11, // 47: flow.DebugEvent.type:type_name -> flow.DebugEventType
	15, // 48: flow.DebugEvent.source:type_name -> flow.Endpoint
	47, // 49: flow.DebugEvent.hash:type_name -> google.protobuf.UInt32Value
	47, // 50: flow.DebugEvent.arg1:type_name -> google.protobuf.UInt32Value
	47, // 51: flow.DebugEvent.arg2:type_name -> google.protobuf.UInt32Value
	47, // 52: flow.DebugEvent.arg3:type_name -> google.protobuf.UInt32Value
	46, // 53: flow.DebugEvent.cpu:type_name -> google.protobuf.Int32Value
